...
public class ServiceManagementController {
    ...
    public ServiceConfiguratedModel saveService(
	    @ApiParam(value = "Modello del tributo", required = true) @RequestBody final TributeServiceModel tributeService) {

	return new ServiceConfiguratedModel(serviceManagementService.saveService(tributeService));
    }
	...
	return serviceManagementService.getService(creditorId);
    }
