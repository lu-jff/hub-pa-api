...
public class PaymentNoticeConstants {
    ...
    public static final String PDF_TEXT_WEBSITE_TOPAY = "PAGA SUL SITO O CON LE APP";
    ...
    public static final String PDF_TEXT_AMOUNT_INFO_PART1 = "L'importo è aggiornato automaticamente dal sistema e potrebbe\r";
    public static final String PDF_TEXT_AMOUNT_INFO_PART2 = "subire variazioni per eventuali sgravi, note di credito, indennità di\r";
    public static final String PDF_TEXT_AMOUNT_INFO_PART3 = "mora, sanzioni o interessi, ecc. Un operatore, il sito o l'app che userai\r";
    public static final String PDF_TEXT_AMOUNT_INFO_PART4 = "ti potrebbero quindi chiedere una cifra diversa da quella qui indicata.";
    public static final String PDF_TEXT_YOUR_CREDITOR_INSTITUTION = "del tuo Ente Creditore ";
    ...
    public static final String PDF_TEXT_PAYMENT_INFO_PART1 = "della tua Banca o degli altri canali di pagamento. ";
    public static final String PDF_TEXT_PAYMENT_INFO_PART2 = "Potrai pagare con carte, conto corrente, CBILL.";
    public static final String PDF_TEXT_PAY_ON_TERRITORY = "PAGA SUL TERRITORIO";
    public static final String PDF_TEXT_WHERE_TOPAY_POSTAL = "\rin tutti gli Uffici Postali, in Banca, in Ricevitoria, dal";
    public static final String PDF_TEXT_WHERE_TOPAY_BANKING = "\rin Banca, in Ricevitoria, dal";
    public static final String PDF_TEXT_WHERE_TOPAY_PART1 = "\rTabaccaio, al Bancomat, al Supermercato.";
    public static final String PDF_TEXT_WHERE_TOPAY_PART2 = "\rPotrai pagare in contanti, con carte o conto corrente.";
    public static final String PDF_TEXT_HOW_TOPAY = "Utilizza la porzione di avviso relativa ";
    public static final String PDF_TEXT_TO_THE_INSTALLMENT = "alla rata ed ";
    public static final String PDF_TEXT_PREFERRED_PAYMENT_CHANNEL = "al canale di pagamento che preferisci.";
    public static final String PDF_TEXT_BANK_OTHER_CHANNEL = "BANCHE E ALTRI CANALI";
    ...
    public static final String PDF_TEXT_BANK_PAYMENT_CODES_PART1 = "Qui accanto trovi il codice ";
    public static final String PDF_TEXT_BANK_PAYMENT_CODES_PART2 = "QR";
    public static final String PDF_TEXT_BANK_PAYMENT_CODES_PART3 = " e\ril codice interbancario ";
    public static final String PDF_TEXT_BANK_PAYMENT_CODES_PART4 = "CBILL\r";
    public static final String PDF_TEXT_BANK_PAYMENT_CODES_PART5 = "per pagare attraverso il circuito\rbancario e gli altri canali di\rpagamento abilitati.";
    ...
    public static final String PDF_TEXT_BANK_INST_3_BANK_INFO_PART1 = "Qui sopra trovi il codice ";
    public static final String PDF_TEXT_BANK_INST_3_BANK_INFO_PART2 = "QR";
    public static final String PDF_TEXT_BANK_INST_3_BANK_INFO_PART3 = " e il codice interbancario\r";
    public static final String PDF_TEXT_BANK_INST_3_BANK_INFO_PART4 = "CBILL ";
    public static final String PDF_TEXT_BANK_INST_3_BANK_INFO_PART5 = "per pagare attraverso il circuito bancario e gli\raltri canali dipagamento abilitati.";
    public static final String PDF_TEXT_BANK_INST_2_BANK_INFO_PART1 = "Qui sopra trovi il codice ";
    public static final String PDF_TEXT_BANK_INST_2_BANK_INFO_PART2 = "QR";
    public static final String PDF_TEXT_BANK_INST_2_BANK_INFO_PART3 = " e il codice interbancario ";
    public static final String PDF_TEXT_BANK_INST_2_BANK_INFO_PART4 = "CBILL ";
    public static final String PDF_TEXT_BANK_INST_2_BANK_INFO_PART5 = "per pagare\rattraverso il circuito bancario e gli altri canali dipagamento abilitati.";
}
