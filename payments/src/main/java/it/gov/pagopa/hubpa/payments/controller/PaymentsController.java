...
public class PaymentsController {
	...
	EnteCreditoreMinimalDto enteCreditoreMinimalDto = this.getEnteCreditore(fiscalCode);
	PaDto paDto = this.getPa(fiscalCode);

	if (enteCreditoreMinimalDto != null && paDto != null) {

	    byte[] pdfByte = paymentService.generatePaymentNotice(paymentPositions, enteCreditoreMinimalDto, paDto,
		    null);
	...
	try (ZipOutputStream zos = new ZipOutputStream(baos)) {
		...
		paymentService.generatePaymentNotice(paymentPositions, enteCreditoreMinimalDto, paDto, zos);
    ...
    private EnteCreditoreMinimalDto getEnteCreditore(String fiscalCode) {
	return restTemplate.getForObject(entePath + "/ente/ente/" + fiscalCode, EnteCreditoreMinimalDto.class);
    }

    private PaDto getPa(String fiscalCode) {
	return restTemplate.getForObject(entePath + "/ente/pa/" + fiscalCode, PaDto.class);
    }
}
